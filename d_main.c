...
*/
    ...
    printf (text[Z_INIT_NUM]);
    Z_Init ();

    printf (text[W_INIT_NUM]);
...
//        gamemode = retail;
  ...
  //-----------------------------------------------------------------
    ...
    printf (text[M_INIT_NUM]);
    M_Init ();

    printf (text[R_INIT_NUM]);
    R_Init ();

    // init all NETWORK
    printf (text[D_CHECKNET_NUM]);
    D_CheckNetGame ();

    //
    // setting up sound
    //
    printf (text[S_SETSOUND_NUM]);
